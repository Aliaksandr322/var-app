...
//            if (word.toLowerCase().startsWith(search.toLowerCase()))searchCount++;
//        }
//        System.out.println("Search '" + search +"' " + searchCount);
//
...
//        System.out.println(subText);
    ...
    public static String substring(String source,String search, int count){
        ...
        if (source != null && search != null && count > 0){
            ...
            while ((index = source.indexOf(search)) != -1 && count > 0){
