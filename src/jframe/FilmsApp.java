...
public class FilmsApp extends JFrame {
    ...
    public FilmsApp(){
        ...
        boarding(buttonNext ,buttonBack ,buttonAdd, buttonSave ,buttonGo ,buttonRemove , buttonUpdate, searchLbl, searchText);
        boarding(uidLbl, imdbRateLbl, nameLbl, typeLbl, dateLbl, actorsLbl, statusLbl);
        ...
        buttonRemove.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(result == JOptionPane.YES_OPTION){
                    ...
                    db = newDB;
                    statusLbl.setText("Film with has been removed successfully!");
                }
                else {
